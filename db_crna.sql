...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2023 at 02:35 PM
...
(1, 'หัสนัย', 'หม้อยา', '20230206_183846819468291images.png', 1);
...
CREATE TABLE `garage` (
  ...
  `garageprofile` text NOT NULL,
  `garagedeegree` int(2) NOT NULL,
...
INSERT INTO `garage` (`garageid`, `garagename`, `garagetel`, `garagehousenum`, `garagegroup`, `garageroad`, `garagealley`, `garagedistrict`, `garagearea`, `garageprovince`, `garagepostcode`, `garagelattitude`, `garagelonggitude`, `garageprofile`, `garagedeegree`, `garageonoff`, `ownerid`, `memid`) VALUES
(1, 'สมชายยานยนต์', '0785658954', '113', '3', '-', '-', '810101', '864', '64', '81000', '8.054593', '98.9109163', 'http://dik-it.com//project-crna/assets/upload/garpro/20230207_0325461068554582car-1751750_960_720.jpg', 4, '1', 1, 2),
(2, 'เกรียงศักดิ์การช่าง', '0758456585', '113/3', '3', '-', '-', '810102', '864', '64', '81170', '8.0539873', '98.9130303', 'http://dik-it.com//project-crna/assets/upload/garpro/20230207_03343389540907aHR0cHM6Ly9zLmlzYW5vb2suY29tL2F1LzAvdWQvMTYvODMwOTEvY2FyX3dvcmtzaG9wLmpwZw.jpg', 3, '1', 2, 3);
...
(1, 'สมชาย นวลดี', '1', '2023-02-07', '0845698584', '113/3', '3', '-', '-', '810202', '865', '64', ' 81140', 'http://dik-it.com//project-crna/assets/upload/machanic/20230207_0336481406697285ดาวน์โหลด.png', '1', 4);
...
CREATE TABLE `members` (
  ...
  `memfullname` varchar(30) NOT NULL,
  `memproflie` text NOT NULL,
...
INSERT INTO `members` (`memid`, `memusername`, `mempassword`, `membersemail`, `memfullname`, `memproflie`, `memtel`, `memlavel`, `memdate`) VALUES
(1, 'admin1', '1234', 'hatsanay022com@gmail.com', 'หัสนัย หม้อยา', 'null', '0980300822', '5', '2023-02-07 03:21:44'),
(2, 'testgarage1', '1234', 'testgarage1@gmail.com', 'null', 'null', 'null', '2', '2023-02-07 00:00:00'),
(3, 'testgarage2', '1234', 'testgarage2com@gmail.com', 'null', 'null', 'null', '2', '2023-02-07 00:00:00'),
(4, 'testmechanic1', '1234', 'testmechanic1@gmail.com', 'null', 'null', 'null', '3', '2023-02-07 00:00:00'),
(5, 'testuser1', '1234', 'saimai@gmail.com', 'สายใหม ยิ้มสวย', 'http://dik-it.com/crna-img/custommer/dedult.png', '0976534567', '1', '2023-02-07 03:39:20'),
(6, 'text', 'text', 'text', 'text', 'http://dik-it.com/crna-img/custommer/dedult.png', 'text', '1', '2023-02-07 08:00:32'),
(7, 'user2', '1234', 'hatsanay022com@gmail.com', 'หัสนัย หม้อยา', 'http://dik-it.com/crna-img/custommer/dedult.png', '0980300822', '1', '2023-02-07 10:09:34'),
(8, 'deejai', '1234', 'deejai@gmail.com', 'null', 'null', 'null', '2', '2023-02-07 00:00:00');
...
INSERT INTO `owner` (`ownerid`, `ownerfname`, `ownerlname`, `ownersex`, `ownerbirthday`, `ownertel`, `ownhousenum`, `owngroup`, `ownalley`, `ownroad`, `owndistrict`, `ownarea`, `ownprovince`, `ownpostcode`) VALUES
(1, 'สมชาย', 'หม้อยา', '1', '2023-02-07', '0980300822', '113/3', '3', '-', '-', 'ปากน้ำ', 'เมืองกระบี่', 'จังหวัดกระบี่', '81000'),
(2, 'เกรียงศักดิ์', 'ใจกล้า', '1', '2023-02-07', '078456585', '113/3', '3', '-', '-', 'คลองพน', 'คลองท่อม', 'จังหวัดกระบี่', '81170');
...
--
-- Table structure for table `repairreq`
--

CREATE TABLE `repairreq` (
  `repairreqid` int(5) NOT NULL,
  `repairname` varchar(30) NOT NULL,
  `repairreqfullname` varchar(30) NOT NULL,
  `repairreqtel` varchar(10) NOT NULL,
  `repairreqcardetial` text NOT NULL,
  `repairreqspecial` text NOT NULL,
  `repairreqproblem` varchar(100) NOT NULL,
  `repairreqlattitude` varchar(20) NOT NULL,
  `repairreqlonggitude` varchar(20) NOT NULL,
  `repairreqdatetime` datetime NOT NULL,
  `repairreqgarageid` int(5) NOT NULL,
  `repairreqmacid` int(5) NOT NULL,
  `repairreqmemid` int(5) NOT NULL,
  `repairreqstatus` int(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `repairreq`
--

INSERT INTO `repairreq` (`repairreqid`, `repairname`, `repairreqfullname`, `repairreqtel`, `repairreqcardetial`, `repairreqspecial`, `repairreqproblem`, `repairreqlattitude`, `repairreqlonggitude`, `repairreqdatetime`, `repairreqgarageid`, `repairreqmacid`, `repairreqmemid`, `repairreqstatus`) VALUES
(1, 'สมชายยานยนต์', 'สายใหม ยิ้มสวย', '0976534567', 'Honda สีขาว', 'หน้าวิทลัยเทคนิคกระบี่', 'ยางแบน', '8.0595047', '98.9060198', '2023-02-07 09:48:22', 1, 0, 5, 5),
(2, 'สมชายยานยนต์', 'สายใหม ยิ้มสวย', '0976534567', 'Yamaha fino', '', 'ยางแบน', '8.0594971', '98.9060555', '2023-02-07 09:59:49', 1, 0, 5, 3),
(3, 'สมชายยานยนต์', 'หัสนัย หม้อยา', '0980300822', 'hon wave สีขาว', 'หน้าวิทลัยเทคนิคกระบี่', 'ยางแบน', '8.0594883', '98.9060534', '2023-02-07 10:12:07', 1, 0, 7, 5);
...
INSERT INTO `review` (`reviewid`, `reviewscore`, `garageid`, `repairreqid`) VALUES
(5, 4, 1, 18),
(6, 3, 1, 18),
(7, 5, 1, 13),
(8, 3, 1, 18),
...
--
-- Indexes for table `repairreq`
--
ALTER TABLE `repairreq`
  ADD PRIMARY KEY (`repairreqid`);
...
--
-- AUTO_INCREMENT for table `repairreq`
--
ALTER TABLE `repairreq`
  MODIFY `repairreqid` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
